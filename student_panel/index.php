...
<head>
    ...
    <title translate="no">GENERATION NT</title>
        ...
        <aside>
            <div class="profile">
                ...
                <div class="about">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<p><h3><strong>Information : </strong></h3></p>
                            <h5>class :</h5>
                    <p>" . $row["class_name"] . "</p>
                    <h5>section :</h5>
                    <p>" . $row["section"] . "</p>
            ...
            <div class="announcements">
                ...
                <div class="updates">
                    <div class="message">
                        ...
                        $sql_query = "SELECT * FROM notice WHERE (role = 'student' AND class='$class') OR (role = 'all' OR role='') ORDER BY s_no DESC LIMIT 6";
