                            ...
                            <div class="col-auto">
                                <select class="form-select" aria-label="Default select example" id="syllabus-class"
                                    ...
                                    <option>ukg</option> -->
                                            ...
                                            if($row["class"]=="12s"){
                                                echo '<option selected value="'.$row["class"].'">Cybersecurity</option>';
                                            }
                                            else if($row["class"]=="12c"){
                                                echo '<option selected value="'.$row["class"].'">Full-Stack Web Development</option>';
                                            }
                                           
                                            else if($row["class"]=="11s"){
                                                echo '<option selected value="'.$row["class"].'">Game Development</option>';
                                            }
                                            else if($row["class"]=="11c"){
                                                echo '<option selected value="'.$row["class"].'">Artificial Intelligence & Data Science</option>';
                                            }
                                            else if($row["class"]=="9"){
                                                echo '<option selected value="'.$row["class"].'">Mobile App Development</option>';
                                            }else if($row["class"]=="10"){
                                                echo '<option selected value="'.$row["class"].'">3D Design</option>';
                                            }
