...
<div class="sidebar">
    <a href="dashboard.php" class="logo">
        ...
        <!--<img src="../images/SCHOOL-LOGO.webp">-->
<div class="logo-name" translate="no"><pre> <br><span class="text-warning">GENERATION</span><br><span class="darkTextColor">          NT     </span></div>
</pre>    </a>
