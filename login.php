...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="./Generation Nt/GNT.jpg">
</head>
...
<body>
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        <img src="./Generation Nt/6.jpg" alt="">
        <div class="text">
          <span class="text-1">GENERATION NT<br></span>
          <span class="text-2">MANAGEMENT SYSTEM</span>
        </div>
      </div>
