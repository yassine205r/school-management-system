...
<div style="display: flex;flex-direction: column; grid-gap: 10px;">
     <div style="display: flex; grid-gap: 10px;">
        <img src="Pictures/1.png" alt="screenshots" width="49%" style="border: 2px solid lightgreen"/>
        <img src="Pictures/6.png" alt="screenshots" width="49%" style="border: 2px solid lightgreen"/>
    </div>
</div>
<br>
